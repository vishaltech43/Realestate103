...
const CommentForm = () => {
  ...
  return (
    <section className="text-gray-600 body-font relative border w-4/5    sm:w-4/5 rounded-2xl mt-12 mx-auto mb-16">
      <div className="container px-5 sm:px-7 pt-7 mx-auto">
        <div className="flex flex-col w-full">
          <h1 className="sm:text-[36px] text-[26px] font-serif font-semibold title-font mb-7 text-black">
            Leave Your Comment
          </h1>
        </div>
        <div>
