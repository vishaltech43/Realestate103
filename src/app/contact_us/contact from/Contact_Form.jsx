...
const Contact_Form = () =>  {
  ...
  const handleSubmit = (e) => {
    ...
    alert('your infomation is recoreded...');
    setFormData({
      name: '',
      email: '',
      phoneNum: '',
  ...
  return (
    <section className="text-gray-600 w-4/5 body-font relative mt-12 mx-auto mb-24 border rounded-2xl ">
      <div className="container px-5 sm:px-7 pt-7 mx-auto">
        <div className="flex flex-col w-full">
          <h1 className="text-black text-4xl font-bold font-serif pb-7">Contact Us</h1>
        </div>
